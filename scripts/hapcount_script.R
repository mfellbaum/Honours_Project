...
vcftools --vcf /data/hartfield/atsweeps/analyses/Vcf_subset_AT.vcf --hapcount hapcount_BED_file_test.bed --chr 1 --min-alleles 2 --max-alleles 2 --remove-indels --max-miss>
  
# Copy file back to head folder
rsync -avz /scratch/mfellbaum/hapcount_chr1_test.hapcount /data/hartfield/atsweeps/analyses/
